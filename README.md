...
7. **Access the Application**
   ...
   **⚠️ Important for Cloud Deployment:**
   ...
   PC browsers require HTTPS to access the microphone API. If you're deploying to a cloud server (not localhost), you **must** configure HTTPS. See the deployment guides:
   - [云端部署HTTPS配置指南.md](./云端部署HTTPS配置指南.md) - Complete HTTPS setup guide
   - [部署检查清单.md](./部署检查清单.md) - Deployment checklist
   - [麦克风权限问题说明.md](./麦克风权限问题说明.md) - Microphone permission issues
